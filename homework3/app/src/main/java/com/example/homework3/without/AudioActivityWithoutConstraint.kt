...
class AudioActivityWithoutConstraint : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_without_constraint)
    ...
    companion object {
        ...
        fun createIntent(context: Context): Intent {
            return Intent(context, AudioActivityWithoutConstraint::class.java)
        }
    }
}